...
import { useCreateCampaignInvite } from './useCreateCampaignInvite'
...
export function InviteCreatorDialog({
  ...
  const form = useAppForm({
    defaultValues,
    validators: {
      onChange: inviteCreatorSchema,
    },
    onSubmit: async ({ value }) => {
      const validationError = getInviteCreatorValidationError(value)
      if (validationError) {
