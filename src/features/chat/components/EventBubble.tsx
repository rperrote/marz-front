...
interface EventBubbleProps {
  ...
  /**
   * `out` = tint fill with colored text (subtle). `in` = solid fill with white
   * text (emphasized). Matches the .pen pair per severity.
   */
  direction: EventDirection
  /** Override default icon if the event has a specific glyph. */
  icon?: LucideIcon
